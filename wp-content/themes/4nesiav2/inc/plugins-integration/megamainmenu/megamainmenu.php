	...
	function mmpm_nav_search_override( $items, $args ) {
		...
		if ( isset( $args->theme_location ) ) {
			...
			if ( ! empty( $GLOBALS['wp_customize'] )
					&& is_array( $mega_main_menu->get_option( $args->theme_location . '_included_components' ) )
					&& ! in_array( 'search_box', $mega_main_menu->get_option( $args->theme_location . '_included_components' ) ) ) {
				$searchform = '';
