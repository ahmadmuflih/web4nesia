...
function lbmn_customizer( $wp_customize ) {
	...
	if ( lbmn_updated_from_first_generation() ) {
		...
		render_slider_control( __( 'Height', 'lbmn' ), 'lbmn_notificationpanel_basic', 22, LBMN_NOTIFICATIONPANEL_HEIGHT_DEFAULT, 'lbmn_notificationpanel_height', null, array(
			'min'  => '40',
			'max'  => '120',
			'step' => '2',
		) );
		...
		render_slider_control( __( 'Height', 'lbmn' ), 'lbmn_topbar_basic', 25, LBMN_TOPBAR_HEIGHT_DEFAULT, 'lbmn_topbar_height', null, array(
			'min'  => '30',
			'max'  => '80',
			'step' => '2',
		) );
		...
		render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_topba_fontr', 340, LBMN_TOPBAR_FIRSTLEVELITEMS_FONTSIZE_DEFAULT, 'lbmn_topbar_firstlevelitems_fontsize', null, array(
			'min'  => '10',
			'max'  => '80',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Icon Size (px)', 'lbmn' ), 'lbmn_topbar_settings', 430, LBMN_TOPBAR_FIRSTLEVELITEMS_ICONSIZE_DEFAULT, 'lbmn_topbar_firstlevelitems_iconsize', null, array(
			'min'  => '5',
			'max'  => '30',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Items Separator Opacity', 'lbmn' ), 'lbmn_topbar_settings', 450, LBMN_TOPBAR_FIRSTLEVELITEMS_SEPARATOR_OPACITY_DEFAULT, 'lbmn_topbar_firstlevelitems_separator_opacity', null, array(
			'min'  => '0',
			'max'  => '1',
			'step' => '0.01',
		) );
		...
		render_checkbox_control( __( 'Enable', 'lbmn' ), 'lbmn_headertop_basic', 20, 1, 'lbmn_headertop_switch' );
		...
		render_slider_control( __( 'Header Height', 'lbmn' ), 'lbmn_headertop_basic', 210, LBMN_HEADERTOP_HEIGHT_DEFAULT, 'lbmn_headertop_height', null, array(
			'min'  => '30',
			'max'  => '200',
			'step' => '2',
		) );
		render_slider_control( __( 'Menu Height', 'lbmn' ), 'lbmn_headertop_basic', 215, LBMN_HEADERTOP_MENUHEIGHT_DEFAULT, 'lbmn_headertop_menu_height', null, array(
			'min'  => '30',
			'max'  => '100',
			'step' => '2',
		) );
		...
		render_slider_control( __( 'Sticky/Mobile Menu Height', 'lbmn' ), 'lbmn_sticky-settings', 230, LBMN_HEADERTOP_STICK_DEFAULT, 'lbmn_headertop_stick_height', null, array(
			'min'  => '30',
			'max'  => '100',
			'step' => '2',
		) );
		render_slider_control( __( 'Sticky/Mobile Menu Padding', 'lbmn' ), 'lbmn_sticky-settings', 234, LBMN_HEADERTOP_STICKY_PADDING_DEFAULT, 'lbmn_headertop_sticky_padding', null, array(
			'min'  => '0',
			'max'  => '60',
			'step' => '2',
		) );
		render_slider_control( __( 'Sticky Scroll Offset (save to apply)', 'lbmn' ), 'lbmn_sticky-settings', 240, LBMN_HEADERTOP_STICKYOFFSET_DEFAULT, 'lbmn_headertop_stickyoffset', null, array(
			'min'  => '0',
			'max'  => '400',
			'step' => '2',
		) );
		...
		render_slider_control( __( 'Maximum Logo Height (% to the height of the top header)', 'lbmn' ), 'lbmn_logo_basic', 40, LBMN_LOGO_IMAGE_HEIGHT_DEFAULT, 'lbmn_logo_height', null, array(
			'min'  => '10',
			'max'  => '100',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Margin top (optional)', 'lbmn' ), 'lbmn_logo_settings', 60, '', 'lbmn_logo_margin_top', null, array(
			'min'  => '-100',
			'max'  => '100',
			'step' => '2',
		) );
		render_slider_control( __( 'Margin left (optional)', 'lbmn' ), 'lbmn_logo_settings', 65, '', 'lbmn_logo_margin_left', null, array(
			'min'  => '-100',
			'max'  => '100',
			'step' => '2',
		) );
		render_slider_control( __( 'Margin right (optional)', 'lbmn' ), 'lbmn_logo_settings', 70, '', 'lbmn_logo_margin_right', null, array(
			'min'  => '-100',
			'max'  => '100',
			'step' => '2',
		) );
		...
		render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_megamenu_font', 330, LBMN_MEGAMENU_FIRSTLEVELITEMS_FONTSIZE_DEFAULT, 'lbmn_megamenu_firstlevelitems_fontsize', null, array(
			'min'  => '10',
			'max'  => '36',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Hover/Active Border Radius', 'lbmn' ), 'lbmn_megamenu_settings', 420, LBMN_HEADERTOP_LINKHOVERBORDERRADIUS_DEFAULT, 'lbmn_megamenu_linkhoverborderradius', null, array(
			'min'  => '0',
			'max'  => '30',
			'step' => '1',
		) );
		render_slider_control( __( 'First Level Items Outer Spacing', 'lbmn' ), 'lbmn_megamenu_settings', 430, LBMN_MEGAMENU_FIRSTLEVELITEMS_SPACING_DEFAULT, 'lbmn_megamenu_firstlevelitems_spacing', null, array(
			'min'  => '0',
			'max'  => '20',
			'step' => '1',
		) );
		render_slider_control( __( 'First Level Items Inner Spacing', 'lbmn' ), 'lbmn_megamenu_settings', 440, LBMN_MEGAMENU_FIRSTLEVELITEMS_INNERSPACING_DEFAULT, 'lbmn_megamenu_firstlevelitems_innerspacing', null, array(
			'min'  => '0',
			'max'  => '20',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Icon Size (px)', 'lbmn' ), 'lbmn_megamenu_settings', 460, LBMN_MEGAMENU_FIRSTLEVELITEMS_ICONSIZE_DEFAULT, 'lbmn_megamenu_firstlevelitems_iconsize', null, array(
			'min'  => '5',
			'max'  => '30',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Items Separator Opacity', 'lbmn' ), 'lbmn_megamenu_settings', 480, LBMN_MEGAMENU_FIRSTLEVELITEMS_SEPARATOR_OPACITY_DEFAULT, 'lbmn_megamenu_firstlevelitems_separator_opacity', null, array(
			'min'  => '0',
			'max'  => '1',
			'step' => '.05',
		) );
		render_slider_control( __( 'Items Separator Opacity', 'lbmn' ), 'lbmn_megamenu_settings', 490, LBMN_TOPBAR_FIRSTLEVELITEMS_SEPARATOR_OPACITY_DEFAULT, 'lbmn_topbar_firstlevelitems_separator_opacity', null, array(
			'min'  => '0',
			'max'  => '1',
			'step' => '0.01',
		) );
		...
		render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_megamenu_dropdown', 380, LBMN_MEGAMENU_DROPDOWN_FONTSIZE_DEFAULT, 'lbmn_megamenu_dropdown_fontsize', null, array(
			'min'  => '10',
			'max'  => '30',
			'step' => '1',
		) );
		render_slider_control( __( 'Icon Size (px)', 'lbmn' ), 'lbmn_megamenu_dropdown', 390, LBMN_MEGAMENU_DROPDOWN_ICONSIZE_DEFAULT, 'lbmn_megamenu_dropdown_iconsize', null, array(
			'min'  => '10',
			'max'  => '30',
			'step' => '1',
		) );
		...
		render_slider_control( __( 'Dropdown Panel Radius', 'lbmn' ), 'lbmn_megamenu_dropdown', 420, LBMN_MEGAMENU_DROPDOWNRADIUS_DEFAULT, 'lbmn_megamenu_dropdownradius', null, array(
			'min'  => '0',
			'max'  => '20',
			'step' => '1',
		) );
		render_slider_control( __( 'Dropdown Marker Opacity', 'lbmn' ), 'lbmn_megamenu_dropdown', 430, LBMN_MEGAMENU_DROPDOWN_MARKEROPACITY_DEFAULT, 'lbmn_megamenu_dropdown_markeropacity', null, array(
			'min'  => '0',
			'max'  => '1',
			'step' => '.01',
		) );
		...
		render_slider_control( __( 'Input Field Width (px)', 'lbmn' ), 'lbmn_searchblock', 110, LBMN_SEARCHBLOCK_INPUTFIELDWIDTH_DEFAULT, 'lbmn_searchblock_inputfieldwidth', null, array(
			'min'  => '100',
			'max'  => '300',
			'step' => '2',
		) );
		render_slider_control( __( 'Input Field Radius (px)', 'lbmn' ), 'lbmn_searchblock', 115, LBMN_SEARCHBLOCK_INPUTFIELDRADIUS_DEFAULT, 'lbmn_searchblock_inputfieldradius', null, array(
			'min'  => '0',
			'max'  => '100',
			'step' => '1',
		) );
	...
	*/
	...
	render_image_control( __( 'Background Image', 'lbmn' ), 'page_layout', 30, 'lbmn_page_background_image' ); // The $default_image - optional parameter.
	render_slider_control( __( 'Background Image Opacity', 'lbmn' ), 'page_layout', 40, '1', 'lbmn_page_background_image_opacity', null, array(
		'min'  => '0',
		'max'  => '1',
		'step' => '.01',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 140, LBMN_TYPOGRAPHY_P_FONTSIZE_DEFAULT, 'lbmn_typography_p_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 150, LBMN_TYPOGRAPHY_P_LINEHEIGHT_DEFAULT, 'lbmn_typography_p_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 160, LBMN_TYPOGRAPHY_P_MARGINBOTTOM_DEFAULT, 'lbmn_typography_p_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 240, LBMN_TYPOGRAPHY_H1_FONTSIZE_DEFAULT, 'lbmn_typography_h1_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 250, LBMN_TYPOGRAPHY_H1_LINEHEIGHT_DEFAULT, 'lbmn_typography_h1_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 260, LBMN_TYPOGRAPHY_H1_MARGINBOTTOM_DEFAULT, 'lbmn_typography_h1_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 340, LBMN_TYPOGRAPHY_H2_FONTSIZE_DEFAULT, 'lbmn_typography_h2_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 350, LBMN_TYPOGRAPHY_H2_LINEHEIGHT_DEFAULT, 'lbmn_typography_h2_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 360, LBMN_TYPOGRAPHY_H2_MARGINBOTTOM_DEFAULT, 'lbmn_typography_h2_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 440, LBMN_TYPOGRAPHY_H3_FONTSIZE_DEFAULT, 'lbmn_typography_h3_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 450, LBMN_TYPOGRAPHY_H3_LINEHEIGHT_DEFAULT, 'lbmn_typography_h3_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 460, LBMN_TYPOGRAPHY_H3_MARGINBOTTOM_DEFAULT, 'lbmn_typography_h3_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 540, LBMN_TYPOGRAPHY_H4_FONTSIZE_DEFAULT, 'lbmn_typography_h4_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 550, LBMN_TYPOGRAPHY_H4_LINEHEIGHT_DEFAULT, 'lbmn_typography_h4_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 560, LBMN_TYPOGRAPHY_H4_MARGINBOTTOM_DEFAULT, 'lbmn_typography_h4_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 640, LBMN_TYPOGRAPHY_H5_FONTSIZE_DEFAULT, 'lbmn_typography_h5_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 650, LBMN_TYPOGRAPHY_H5_LINEHEIGHT_DEFAULT, 'lbmn_typography_h5_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 660, LBMN_TYPOGRAPHY_H5_MARGINBOTTOM_DEFAULT, 'lbmn_typography_h5_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_typography', 740, LBMN_TYPOGRAPHY_H6_FONTSIZE_DEFAULT, 'lbmn_typography_h6_fontsize', null, array(
		'min'  => '10',
		'max'  => '80',
		'step' => '1',
	) );
	render_slider_control( __( 'Line Height (px)', 'lbmn' ), 'lbmn_typography', 750, LBMN_TYPOGRAPHY_H6_LINEHEIGHT_DEFAULT, 'lbmn_typography_h6_lineheight', null, array(
		'min'  => '5',
		'max'  => '100',
		'step' => '1',
	) );
	render_slider_control( __( 'Margin Bottom (px)', 'lbmn' ), 'lbmn_typography', 760, LBMN_TYPOGRAPHY_H6_MARGINBOTTOM_DEFAULT, 'lbmn_typography_h6_marginbottom', null, array(
		'min'  => '0',
		'max'  => '100',
		'step' => '1',
	) );
	...
	if ( lbmn_updated_from_first_generation() ) {
		...
		render_slider_control( __( 'Height', 'lbmn' ), 'lbmn_calltoaction', 22, LBMN_CALLTOACTION_HEIGHT_DEFAULT, 'lbmn_calltoaction_height', null, array(
			'min'  => '60',
			'max'  => '200',
			'step' => '2',
		) );
		...
		render_slider_control( __( 'Font Size (px)', 'lbmn' ), 'lbmn_calltoaction', 100, LBMN_CALLTOACTION_FONTSIZE_DEFAULT, 'lbmn_calltoaction_fontsize', null, array(
			'min'  => '10',
			'max'  => '80',
			'step' => '1',
		) );
...
function lbmn_customize_preview_js() {
	wp_enqueue_script( 'lbmn_customizer_preview', get_template_directory_uri() . '/inc/customizer/customizer-preview.js', array( 'lbmn-custom-js' ), SEOWP_THEME_VER, true );
...
function lbmn_add_customizer_js() {
	...
	wp_enqueue_script( 'lbmn_customizer_tinycolor_js', get_template_directory_uri() . '/inc/customizer/jquery-colorpickersliders/jquery.colorpickersliders.js', array( 'jquery' ), SEOWP_THEME_VER, true );
	wp_enqueue_script( 'lbmn_customizer_customcolorpicker_js', get_template_directory_uri() . '/inc/customizer/jquery-colorpickersliders/tinycolor.js', array(
		'jquery',
		'lbmn_customizer_tinycolor_js',
	), SEOWP_THEME_VER, true );
	...
	wp_enqueue_script( 'lbmn_customizer_adminjs', get_template_directory_uri() . '/inc/customizer/customizer-admin.js', array( 'jquery' ), SEOWP_THEME_VER, true ); //  array( 'jquery', 'iris', 'wp-color-picker' )
	wp_enqueue_style( 'lbmn_customizer_adminstyle', get_template_directory_uri() . '/inc/customizer/customizer-admin.css', array(), SEOWP_THEME_VER );
	...
	wp_enqueue_script( 'lbmn_chosen_selectorjs', get_template_directory_uri() . '/javascripts/chosen/chosen.jquery.min.js', array( 'jquery' ), SEOWP_THEME_VER, true );
